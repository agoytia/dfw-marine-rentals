...
const Additional = (propTypes) => (
  <React.Fragment>
    {/* <!-- Additional Elements --> */}
    <section className="wrapper style1 align-center">
      <div className="inner">
        <h2>Additional Elements</h2>
        <p>Finally, here are some additional elements you <em>might</em> find useful (and yup, they look fine with any <span className="demo-controls">appearance</span>).</p>
          ...
          <section>
            ...
            <div className="content">
              ...
              <p>This is <b>bold</b> and this is <strong>strong</strong>. This is <i>italic</i> and this is <em>emphasized</em>.
                ...
                This is <u>underlined</u> and this is code: <code>$ apt-get</code>.
          ...
          <section>
            ...
            <div className="content">
              ...
              <ul className="icons">
                ...
                <li><a href="/" className="icon style1 fa-dribbble"><span className="label">Dribbble</span></a></li>
              </ul>
        ...
        <div className="index align-left">
          ...
          <section id="reference-banner">
            ...
            <div className="content">
              ...
              <h4>HTML</h4>
              <pre><code>&lt;section className="banner style<em>(N)</em> <em>(optional modifiers)</em>"&gt;
                &lt;div className="content"&gt;
                <em>(content)</em>
                &lt;/div&gt;
                &lt;div className="image"&gt;
          ...
          <section id="reference-spotlight">
            ...
            <div className="content">
              ...
              <h4>HTML</h4>
              <pre><code>&lt;section className="spotlight style<em>(N)</em> <em>(optional modifiers)</em>"&gt;
                &lt;div className="content"&gt;
                <em>(content)</em>
                &lt;/div&gt;
                &lt;div className="image"&gt;
          ...
          <section id="reference-gallery">
            ...
            <div className="content">
              ...
              <h4>HTML</h4>
              <pre><code>&lt;div className="gallery style<em>(N)</em> <em>(optional modifiers)</em>"&gt;
                &lt;article&gt;
                &lt;a href="<em>(full image URL)</em>" className="image"&gt;
          ...
          <section id="reference-items">
            ...
            <div className="content">
              ...
              <h4>HTML</h4>
              <pre><code>&lt;div className="items style<em>(N)</em> <em>(size modifier)</em> <em>(optional modifiers)</em>"&gt;
                &lt;section&gt;
                <em>(content)</em>
                &lt;/section&gt;
                &lt;section&gt;
          ...
          <section id="reference-wrapper">
            ...
            <div className="content">
              ...
              <h4>HTML</h4>
              <pre><code>&lt;div className="wrapper <em>(optional modifiers)</em>"&gt;
                <em>(content)</em>
                &lt;/div&gt;</code></pre>
